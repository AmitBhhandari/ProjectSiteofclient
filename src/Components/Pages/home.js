...
const home = () => {
  return (
      ...
      <Row>
        ...
        <Col md={4}>
          <Card>
            <Image src="https://content.jdmagicbox.com/comp/hyderabad/u8/040pxx40.xx40.190916125838.q6u8/catalogue/pheonix-software-solutions-new-nallakunta-hyderabad-cctv-computer-software-dealers-o97ohcyykc.jpg?clr=333333" fluid />
            <Card.Body>
        ...
        <Col md={4}>
          <Card>
            <Image src="https://www.computerrepairhomeservice.in/wp-content/uploads/2019/06/Laptop-Repair-Service-at-Home-in-Sector-66-Noida.png" fluid />
            <Card.Body>
